        ...
        return {
           ...
           link: function(scope, elem, attrs) {
               ...
               var dataArray = [], // for filling data in array
				rss = angular.element('<div id= "rss"><div id="dvRssCaption" class="moduleHeaderStyle" ng-show="rssText.length>0 && orientation==true" > {{rssText}}</div> <div  class ="rssStyle" ><marquee behavior="scroll" direction="left"><ul><li class ="rssText" ng-repeat="item in itemArray" > >> {{item}}</li></ul></marquee></div></div>');
