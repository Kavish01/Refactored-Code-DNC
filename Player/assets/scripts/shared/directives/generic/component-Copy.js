angular
    	...
    	function(compile, sce, interval, content, configService) 
	{
        ...
        return {
            restrict: 'AE',
          	template: '<div id="dvgenericCaption" class="moduleHeaderStyle" ng-show="generictext.length>0 && orientation==true" > {{generictext}}</div><div class="genericmodule-container"></div>',
            scope: {
              load:"=",
			  orientation:"@"
                                  ...
                                  //  alert("inside if with video value");
                                      ...
                                      else
                                    {
                                       //console.log("inside else generic html player with video value"+moduleData.length);
                                        for (var k = 0; k < moduleData.length; k++) 
                                            {
                                               //console.log("inside for loop in generic");
                                                playGenericItem(k, element);
                                            }
                                    }
